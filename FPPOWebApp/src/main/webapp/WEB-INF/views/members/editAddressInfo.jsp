...
<div class="content">
	...
	<form:form commandName="editAddressInfoForm" action="save" method="POST" cssClass="form-horizontal">
		<div class="form-group">
			<label for="addressLine1" class="col-sm-2 control-label">Address Line 1</label>
			<div class="col-sm-10">
				<form:input path="addressLine1" name="addressLine1" cssClass="form-control"/>
			</div>
		</div>
		<div class="form-group">
			<label for="addressLine2" class="col-sm-2 control-label">Address Line 2</label>
			<div class="col-sm-10">
				<form:input path="addressLine2" name="addressLine2" cssClass="form-control"/>
			</div>
		</div>
		<div class="form-group">
		...
		<div class="form-group">
			...
			<div class="col-sm-10">
				<form:input path="postalCode" name="postalCode" cssClass="form-control"/>
			</div>
		</div>
		<div class="form-group">
