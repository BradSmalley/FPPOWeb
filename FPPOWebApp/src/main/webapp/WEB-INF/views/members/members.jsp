	...
	<div class="content">
		...
		<div id="row">
			<div id="userInfo" class="col-lg-4 col-md-4">
				...
				<div class="row">
					<div class="col-lg-4"><label for="username">Username:</label></div>
					<div class="col-lg-8">${fn:escapeXml(user.username)}</div>
				</div>
				<div class="row">
					<div class="col-lg-4"><label for="firstname">First Name:</label></div>
					<div class="col-lg-8">${fn:escapeXml(user.firstname)}</div>
				</div>
				<div class="row">
					<div class="col-lg-4"><label for="lastname">Last Name:</label></div>
					<div class="col-lg-8">${fn:escapeXml(user.lastname)}</div>
				</div>
				<div class="row">
			...
			<div id="addressInfo" class="col-lg-4 col-md-4">
				...
				<div class="col-lg-12">
					<c:forEach items="${user.addresses}" var="address">
						...
						<div class="row">
							<div class="col-lg-12" style="margin-top: 1em;">
								<a href="<c:url value='editAddressInfo' />">Edit</a>
							</div>
						</div>
					</c:forEach>
				</div>
			...
			<div id="phoneInfo" class="col-lg-4 col-md-4">
				...
				<c:forEach items="${user.phoneNumbers}" var="phone">
					...
					<div class="row">
						<div class="col-lg-12" style="margin-top: 1em;">
							<a href="<c:url value="editPhoneInfo" />">Edit</a>
						</div>
					</div>
				</c:forEach>
			</div>
